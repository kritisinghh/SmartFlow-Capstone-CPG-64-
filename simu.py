...
if __name__ == "__main__":
    ...
    plt.plot(depart_times, co2_emission, color='green')
...
np.save(os.path.join(results_dir, "maddpg_co2.npy"), np.array(co2_emission))
np.save(os.path.join(results_dir, "maddpg_fuel.npy"), np.array(fuel_cons))